...
//	private HashMap<String , Cookie> cookieHashMap = new HashMap<String , Cookie>();
	
	private static String charType = "UTF-8";
	
	/**
	 * 쿠키(cookie) request 객체에서 가지고와서 cookieMap(Map) 객체에 주입
	 * @param request
	 */
	...
	public String getValue(String name) throws IOException {
		...
		return URLDecoder.decode(cookie.getValue(),charType);	//sys win euc-kr
	}
