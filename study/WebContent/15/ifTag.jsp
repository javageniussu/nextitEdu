...
<%@page import="kr.or.nextit.mber.service.impl.MberServiceDao"%>
...
<pre>
 ...
 <%
 	...
 	/* mberService.getMemberItem("test"); */
 	MberVo mberInfo = mberService.getMemberItem("test");
 %>
 ...
 <!-- request.setAtrribute("member", member); -->
